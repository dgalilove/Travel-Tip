    ...
    var strHTML = locs.map(loc => {
        ...
        <li class="loc ${className}" data-id="${loc.id}">
            ...
            <div class="loc-btns">     
               ...
               <button title="Select" onclick="app.onSelectLoc('${loc.id}' , '${gUserPos ? distance : undefined}')">🗺️</button>
            </div>     
        </li>`
    })
        .join("")
...
function onRemoveLoc(locId) {
    const isConfirm = confirm("Please confirm the removal!")
    if (!isConfirm) return
    locService
        .remove(locId)
        .then(() => {
